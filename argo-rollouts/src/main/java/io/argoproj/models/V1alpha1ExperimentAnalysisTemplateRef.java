...
/**
 * V1alpha1ExperimentAnalysisTemplateRef
 */
...
public class V1alpha1ExperimentAnalysisTemplateRef {
  ...
  public V1alpha1ExperimentAnalysisTemplateRef args(List<V1alpha1Argument> args) {
    
    this.args = args;
    return this;
  }

  public V1alpha1ExperimentAnalysisTemplateRef addArgsItem(V1alpha1Argument argsItem) {
    if (this.args == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Args are the arguments that will be added to the AnalysisRuns")
  ...
  public V1alpha1ExperimentAnalysisTemplateRef clusterScope(Boolean clusterScope) {
  ...
  **/
  ...
  public V1alpha1ExperimentAnalysisTemplateRef name(String name) {
  ...
  **/
  ...
  public V1alpha1ExperimentAnalysisTemplateRef requiredForCompletion(Boolean requiredForCompletion) {
  ...
  **/
  ...
  public V1alpha1ExperimentAnalysisTemplateRef templateName(String templateName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ExperimentAnalysisTemplateRef v1alpha1ExperimentAnalysisTemplateRef = (V1alpha1ExperimentAnalysisTemplateRef) o;
    return Objects.equals(this.args, v1alpha1ExperimentAnalysisTemplateRef.args) &&
        Objects.equals(this.clusterScope, v1alpha1ExperimentAnalysisTemplateRef.clusterScope) &&
        Objects.equals(this.name, v1alpha1ExperimentAnalysisTemplateRef.name) &&
        Objects.equals(this.requiredForCompletion, v1alpha1ExperimentAnalysisTemplateRef.requiredForCompletion) &&
        Objects.equals(this.templateName, v1alpha1ExperimentAnalysisTemplateRef.templateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1ExperimentAnalysisTemplateRef {\n");
