...
/**
 * V1alpha1ExperimentSpecAnalyses
 */
...
public class V1alpha1ExperimentSpecAnalyses {
  ...
  public V1alpha1ExperimentSpecAnalyses args(List<V1alpha1AnalysisTemplateSpecArgs> args) {
    
    this.args = args;
    return this;
  }

  public V1alpha1ExperimentSpecAnalyses addArgsItem(V1alpha1AnalysisTemplateSpecArgs argsItem) {
    if (this.args == null) {
  ...
  **/
  ...
  public V1alpha1ExperimentSpecAnalyses clusterScope(Boolean clusterScope) {
  ...
  **/
  ...
  public V1alpha1ExperimentSpecAnalyses name(String name) {
  ...
  **/
  ...
  public V1alpha1ExperimentSpecAnalyses requiredForCompletion(Boolean requiredForCompletion) {
  ...
  **/
  ...
  public V1alpha1ExperimentSpecAnalyses templateName(String templateName) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1ExperimentSpecAnalyses v1alpha1ExperimentSpecAnalyses = (V1alpha1ExperimentSpecAnalyses) o;
    return Objects.equals(this.args, v1alpha1ExperimentSpecAnalyses.args) &&
        Objects.equals(this.clusterScope, v1alpha1ExperimentSpecAnalyses.clusterScope) &&
        Objects.equals(this.name, v1alpha1ExperimentSpecAnalyses.name) &&
        Objects.equals(this.requiredForCompletion, v1alpha1ExperimentSpecAnalyses.requiredForCompletion) &&
        Objects.equals(this.templateName, v1alpha1ExperimentSpecAnalyses.templateName);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1ExperimentSpecAnalyses {\n");
