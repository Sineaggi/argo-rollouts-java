 ...
 */
@ApiModel(description = "RolloutAnalysisBackground defines a template that is used to create a background analysisRun")
...
public class V1alpha1RolloutAnalysisBackground {
  ...
  public V1alpha1RolloutAnalysisBackground args(List<V1alpha1AnalysisRunArgument> args) {
    
    this.args = args;
    return this;
  }

  public V1alpha1RolloutAnalysisBackground addArgsItem(V1alpha1AnalysisRunArgument argsItem) {
    if (this.args == null) {
  ...
  **/
  ...
  public V1alpha1RolloutAnalysisBackground dryRun(List<V1alpha1DryRun> dryRun) {
    
    this.dryRun = dryRun;
    return this;
  }

  public V1alpha1RolloutAnalysisBackground addDryRunItem(V1alpha1DryRun dryRunItem) {
    if (this.dryRun == null) {
  ...
  **/
  ...
  public V1alpha1RolloutAnalysisBackground measurementRetention(List<V1alpha1MeasurementRetention> measurementRetention) {
    
    this.measurementRetention = measurementRetention;
    return this;
  }

  public V1alpha1RolloutAnalysisBackground addMeasurementRetentionItem(V1alpha1MeasurementRetention measurementRetentionItem) {
  ...
  **/
  ...
  public V1alpha1RolloutAnalysisBackground startingStep(Integer startingStep) {
   ...
   /**
   * StartingStep indicates which step the background analysis should start on If not listed, controller defaults to 0
   * @return startingStep
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "StartingStep indicates which step the background analysis should start on If not listed, controller defaults to 0")
  ...
  public V1alpha1RolloutAnalysisBackground templates(List<V1alpha1RolloutAnalysisTemplate> templates) {
    
    this.templates = templates;
    return this;
  }

  public V1alpha1RolloutAnalysisBackground addTemplatesItem(V1alpha1RolloutAnalysisTemplate templatesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1RolloutAnalysisBackground v1alpha1RolloutAnalysisBackground = (V1alpha1RolloutAnalysisBackground) o;
    return Objects.equals(this.args, v1alpha1RolloutAnalysisBackground.args) &&
        Objects.equals(this.dryRun, v1alpha1RolloutAnalysisBackground.dryRun) &&
        Objects.equals(this.measurementRetention, v1alpha1RolloutAnalysisBackground.measurementRetention) &&
        Objects.equals(this.startingStep, v1alpha1RolloutAnalysisBackground.startingStep) &&
        Objects.equals(this.templates, v1alpha1RolloutAnalysisBackground.templates);
  }

  @Override
  public int hashCode() {
    return Objects.hash(args, dryRun, measurementRetention, startingStep, templates);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1RolloutAnalysisBackground {\n");
