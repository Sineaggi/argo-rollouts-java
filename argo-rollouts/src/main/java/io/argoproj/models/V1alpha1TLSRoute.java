 ...
 */
@ApiModel(description = "TLSRoute holds the information on the virtual service's TLS/HTTPS routes that are desired to be matched for changing weights.")
...
public class V1alpha1TLSRoute {
  ...
  public V1alpha1TLSRoute port(Long port) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Port number of the TLS Route desired to be matched in the given Istio VirtualService.")
  ...
  public V1alpha1TLSRoute sniHosts(List<String> sniHosts) {
    
    this.sniHosts = sniHosts;
    return this;
  }

  public V1alpha1TLSRoute addSniHostsItem(String sniHostsItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of all the SNI Hosts of the TLS Route desired to be matched in the given Istio VirtualService.")
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1TLSRoute v1alpha1TLSRoute = (V1alpha1TLSRoute) o;
    return Objects.equals(this.port, v1alpha1TLSRoute.port) &&
        Objects.equals(this.sniHosts, v1alpha1TLSRoute.sniHosts);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1TLSRoute {\n");
